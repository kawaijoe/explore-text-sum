...
all_train_urls = "url_lists/final_train_example.txt"
all_val_urls = "url_lists/final_eval_example.txt"
all_test_urls = "url_lists/final_test_example.txt"

cnn_tokenized_stories_dir = "cnn_stories_tokenized"
dm_tokenized_stories_dir = "dm_stories_tokenized"
finished_files_dir = "finished_files_example"
...
def chunk_file(set_name):
  in_file = 'finished_files_example/%s.bin' % set_name
...
def tokenize_stories(stories_dir, tokenized_stories_dir):
  ...
  command = ['java', '-cp', '/home/kawaijoe/stanford-corenlp-3.9.1.jar', 'edu.stanford.nlp.process.PTBTokenizer', '-ioFileList', '-preserveLines', 'mapping.txt'] # Command line to run stanford tokenizer
